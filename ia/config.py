...
HIGH_LEVEL_ALLY_BROADCAST_MAX_AGE = 12
OUTGOING_BROADCAST_BASE_REPEAT_INTERVAL = 8
OUTGOING_BROADCAST_REPEAT_INTERVAL_PER_LEVEL = 2
INCANTATION_CALL_BASE_REPEAT_INTERVAL = 6
INCANTATION_CALL_REPEAT_INTERVAL_PER_LEVEL = 0
HIGH_LEVEL_INCANTATION_CALL_REPEAT_INTERVAL = 4
